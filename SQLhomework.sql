...
-- use the data type `BLOB` (Make sure to research the type `BLOB`, as the difference 
...
SELECT last_name, count(last_name) AS 'last_name_num'
FROM actor
GROUP BY last_name;
...
SELECT f.title, COUNT(fa.actor_id) AS 'ActorNum'
